...
description: Announcing Bagaço v2: the largest open pretraining dataset for European Portuguese. 9.7 billion tokens, and a total of 37GB of text, available on Hugging Face. 
date: 12th of May 2026
status: published
audio: true
thumbnail: images/103/semester_educational_score_summary.webp

<center>
<a href="{static}/images/103/semester_educational_score_summary.webp" target="_blank">
<img src="{static}/images/103/semester_educational_score_summary.webp" alt="Semester educational score summary for Bagaço v2" style="max-width:100%;border-radius: 2px;">
</a>
<figcaption>
...
With those two pieces in place, maybe you guessed where this was going: [Bagaço v2](https://huggingface.co/datasets/duarteocarmo/fineweb2-bagaco2).

<iframe
  src="https://huggingface.co/datasets/duarteocarmo/fineweb2-bagaco2/embed/viewer/all/train"
  frameborder="0"
  width="100%"
  height="560px"
></iframe>
...
It takes the Portuguese split from [CulturaX](https://huggingface.co/datasets/uonlp/CulturaX), and uses the classifier I built to only keep the European Portuguese documents (with confidence above 70%) – like before – it also gives each document an educational score and content category.

<center>
<a href="{static}/images/103/top_educational_score_domains_table.webp" target="_blank">
  <img src="{static}/images/103/top_educational_score_domains_table.webp" alt="Top educational score domains in Bagaço v2" style="max-width:80%;border-radius: 2px;">
</a>
<figcaption>
Top domains by educational score in Bagaco v2.
</figcaption>
</center>

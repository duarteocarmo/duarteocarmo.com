...
status: published
thumbnail: images/111/cover.webp

<center>
<a href="{static}/images/111/pi-tools-banner.webp" target="_blank">
<img src="{static}/images/111/pi-tools-banner.webp" alt="pi-tools banner" style="max-width:100%;border-radius: 2px">
</a>
</center>
...
<center>
<video style="display:block;max-width:100%;border-radius: 2px" autoplay loop muted playsinline controls>
  <source src="{static}/images/111/pi-subagents-demo.mp4" type="video/mp4">
</video>
<figcaption style="margin-top:0">Simple subagents with pi-subagents</figcaption>
</center>
